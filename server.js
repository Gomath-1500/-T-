...
아래 정보를 바탕으로 간결하고 핵심만 담은 리포트를 작성해 주세요.

[작성 규칙]
- 인사말은 반드시 아래 문장으로 시작:
${greeting}
- 출결, 태도, 과제(전날 과제 수행 상태)를 입력값에 맞게 반영
- **"과제:"에는 오늘 새로 배포한 과제를 학부모에게 안내하는 내용으로 작성.**
  (예: "다음 수업까지 이차방정식 끝까지 풀어오세요.")
- 과제 수행 상태(전날 과제에 대한 평가)는 "과제:" 항목에 쓰지 말고, 출결/태도 뒤에 한 줄로 반영
  (예: "과제 수행 상태는 미흡했습니다.")
